...
import pobj.motx.tme3.csp.StratContrainte;
import pobj.motx.tme3.csp.StrategyBasic;
import pobj.motx.tme3.csp.StrategyFrequency;
import pobj.motx.tme3.csp.StrategyRandom;
	...
	public class GrilleSolverTest {
		...
		public void testEnonce() {
			...
			//solver.setChoixVarStrat(new StratContrainte());
			
			//solver.setChoixValeurStrat(new StrategyBasic());
			//solver.setChoixValeurStrat(new StrategyRandom());
			//solver.setChoixValeurStrat(new StrategyFrequency());
